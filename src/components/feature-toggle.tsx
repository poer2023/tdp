...
export function ComingSoonFallback() {
  return (
    <div className="rounded-lg border border-stone-200 bg-white p-8 text-center dark:border-stone-800 dark:bg-stone-900">
      <div className="mx-auto max-w-md">
        ...
        <h3 className="mt-4 text-sm font-medium text-stone-900 dark:text-stone-100">功能即将上线</h3>
        <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">此功能正在开发中,敬请期待</p>
      </div>
    </div>
  );
}
