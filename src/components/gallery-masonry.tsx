        ...
        return (
          <figure key={img.id} className="mb-4 break-inside-avoid">
            <Link
              ...
              className="group block overflow-hidden rounded-md ring-1 ring-zinc-200 transition-shadow hover:shadow-sm dark:ring-zinc-800"
            >
              <Image
            ...
            {(img.title || img.description) && (
              <figcaption className="px-1.5 pt-1.5 text-xs text-zinc-600 dark:text-zinc-400">
