  ...
  return (
    <Card variant="default" className="flex min-h-[320px] flex-col">
      <CardContent className="flex h-full flex-col gap-4">
              ...
              >
                ...
                {image.isLivePhoto && (
                  <Chip
                    ...
                    color="warning"
                    variant="flat"
                    className="absolute top-2 left-2 font-semibold text-white shadow-lg backdrop-blur-sm"
                  >
                    LIVE
                  </Chip>
                )}
        ...
        <Link
          href="/admin/gallery"
          className="mt-auto block text-center text-xs font-medium text-zinc-500 transition-colors hover:text-zinc-900 dark:text-zinc-500 dark:hover:text-zinc-100"
        >
          View all →
        </Link>
      </CardContent>
