...
export const FRIENDS_DATA: Friend[] = [
    { id: 'f1', name: 'Alice Guo', description: 'Colleague from Tencent', createdAt: '2023-01-12' },
    { id: 'f2', name: 'Bob Chen', description: 'University Classmate', createdAt: '2023-03-05' },
    { id: 'f3', name: 'Charlie', description: 'Met at conference', createdAt: '2023-06-20' },
];
