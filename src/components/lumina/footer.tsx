    ...
    <footer className="mt-20 w-full border-t border-stone-100 bg-white py-12 transition-colors dark:border-[#1f1f23] dark:bg-[#0a0a0b]">
      <div className="mx-auto flex max-w-4xl flex-col items-center px-4 text-center">
        ...
        <div className="mb-8 flex gap-6">
          <a
            href="#"
            className="rounded-full p-2 text-stone-400 transition-all hover:bg-stone-50 hover:text-stone-800 dark:hover:bg-[#1f1f23] dark:hover:text-stone-100"
          >
            <Twitter size={20} />
          </a>
          <a
        ...
        <p className="text-sm text-stone-400">
          © {new Date().getFullYear()} Zhi. {t("Designed with")} React, Tailwind & Caffeine.
        </p>
      </div>
    </footer>
  );
