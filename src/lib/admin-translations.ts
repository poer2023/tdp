...
export const adminTranslations = {
  ...
  zh: {
    ...
    credentialsDescription: "管理 API 凭据并从外部平台同步数据",
    newCredential: "新建凭据",
    ...
    activeStatus: "活跃",
    needsAttention: "需要处理",
    noCredentialsConfigured: "暂无已配置的凭据",
    addCredentialToSync: "添加凭据以开始同步数据",
    displayName: "显示名称",
    credentialValueLabel: "凭据值（Cookie/Token/API Key）",
    pasteCredentialHere: "在此粘贴您的 Cookie、令牌或 API 密钥...",
    tokenType: "令牌",
    syncedStatus: "已同步",
    justNow: "刚刚",
    minutesAgo: "分钟前",
    ...
    daysAgo: "天前",
    syncingData: "正在同步数据...",
    lastSyncProcessed: "上次同步：处理了 {count} 条，耗时 {duration}ms",
    lastSyncFailed: "上次同步失败",
    syncing: "同步中...",
    platformAndValueRequired: "平台和凭据值为必填",
    startingSyncFor: "正在为 {platform} 启动同步...",
    syncedSuccessfully: "{platform} 同步成功！",
    failedToSync: "同步 {platform} 失败",
    validatingCredentialMsg: "正在验证 {platform} 凭据...",
    credentialIsValid: "{platform} 凭据有效！",
    credentialsRefreshed: "凭据已刷新",
    failedToRefreshCredentials: "刷新凭据失败",
    confirmDeleteCredentialMsg: "确定要删除 {platform} 凭据吗？",
    credentialDeletedMsg: "{platform} 凭据已删除",
    failedToDeleteCredential: "删除凭据失败",
    validateFirst: "请先验证凭据",
    ...
    // Storage
    storage: "存储管理",
    storageDescription: "管理文件存储和 R2/S3 配置",
    storageConfig: "存储配置",
    storageType: "存储类型",
    s3Endpoint: "S3/R2 端点",
    s3Region: "区域",
    ...
    s3SecretKey: "访问密钥",
    s3CdnUrl: "CDN URL（可选）",
    filesInStorage: "存储文件数",
    totalStorage: "总存储量",
    imageFiles: "图片",
    videoFiles: "视频",
    otherFiles: "其他",
    configuredCorrectly: "已配置",
    notConfigured: "未配置",
    accessible: "可访问",
    notAccessible: "不可访问",
    localStorageMode: "本地存储",
    r2StorageMode: "Cloudflare R2",
    s3StorageMode: "S3 兼容存储",
    testConnection: "测试连接",
    saveConfig: "保存配置",
    deleteFile: "删除文件",
    ...
    configureStorageHint: "配置 R2/S3 存储以进行云端文件管理",
    restartRequired: "更改需要重启服务器才能生效",
    currentConfig: "当前配置",
    envVarsReadOnly: "环境变量为只读。请通过部署设置更新。",
  },
} as const;
