...
import { softDeleteMomentAction } from "../../m/manage-actions";
...
export default async function MomentsPageZh({ searchParams }: Props) {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-10">
      ...
      <form className="mb-4 flex items-center gap-2" method="get">
        ...
        {(tag || q) && (
          <Link href="/zh/m" className="text-xs text-zinc-500 underline">
            清除
          </Link>
        )}
      </form>
